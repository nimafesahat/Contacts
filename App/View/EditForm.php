...
<html lang="en">
  ...
  <body>   
    <div class="container">
      <h1>Show Contact</h1>
      <h3>Profile : <img class="avatar" src="/Contacts/img/<?php echo $contact['profile'] ?>"> </h3>
      <form method="post" action="/Contacts/user/edit" enctype="multipart/form-data"   >
        ...
        <a href='/Contacts/user/delete/<?php echo $contact['id'] ?>'><button type="button" id='delete'>Delete</button></a>
      </form>
    </div>
  </body>
</html>
